...
import styles from '../styles/sass/_Trending.module.scss';
   ...
   <div className={styles.container} >
   {
    dataBookMark.map(da => {
        return( 
            ...
            (da.thumbnail.trending && (

                <div key={da.title} className={styles.principal} >
                    <Image className={styles.img1} src={da.thumbnail.trending.small} fill={"outfit"} alt='image'  priority/> 
                    <Image className={styles.img2} src={da.thumbnail.trending.large} fill={"outfit"} alt='image'  priority/>
